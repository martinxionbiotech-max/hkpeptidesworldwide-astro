...
schema_jsonld: |
  {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "FAQPage",
        "mainEntity": [
          { "@type": "Question", "name": "What chronic in vivo study designs does the SS-31 30 mg format support?", "acceptedAnswer": { "@type": "Answer", "text": "The 30 mg format supports chronic rodent studies of 2-4 weeks duration at standard doses (2-5 mg/kg/day). For example, a 4-week study treating 10 mice at 3 mg/kg/day requires approximately 21 mg total — comfortably within a single 30 mg vial. This format is ideal for longitudinal mitochondrial function assessments, aging intervention studies, and chronic disease models requiring sustained daily dosing." } },
          { "@type": "Question", "name": "How does SS-31 compare to MitoQ for mitochondrial research applications?", "acceptedAnswer": { "@type": "Answer", "text": "SS-31 and MitoQ employ fundamentally different mitochondrial targeting and protective mechanisms. MitoQ (mitoquinone) uses a triphenylphosphonium (TPP⁺) cation for ΔΨm-driven mitochondrial uptake and functions as a chain-breaking antioxidant via its ubiquinone moiety. SS-31 achieves superior mitochondrial accumulation (1000-5000× vs 100-500×) and operates via cardiolipin stabilization rather than direct ROS scavenging. For research applications, SS-31 provides a complementary tool that addresses the upstream initiating events of mitochondrial oxidative damage." } },
          { "@type": "Question", "name": "What is the recommended SS-31 dose for mouse models of heart failure?", "acceptedAnswer": { "@type": "Answer", "text": "Published rodent heart failure studies have employed SS-31 at 2-5 mg/kg/day via subcutaneous or intraperitoneal injection. In the widely cited canine heart failure model (Sabbah et al., 2016), chronic SS-31 administration at 0.25-1.0 mg/kg/hr via subcutaneous osmotic minipump improved left ventricular ejection fraction and reduced biomarkers of mitochondrial oxidative stress. Mouse studies typically use daily bolus dosing at 2-3 mg/kg with treatment durations of 2-8 weeks." } },
          { "@type": "Question", "name": "Can SS-31 30 mg be used for large animal research models?", "acceptedAnswer": { "@type": "Answer", "text": "The 30 mg format is primarily suited for rodent-scale research. Large animal models (rabbit, pig, dog, non-human primate) require substantially greater quantities — typically 50-500 mg depending on body weight and treatment duration. For large animal research, contact HKPEPTIDE WORLDWIDE for custom bulk ordering options that provide gram-scale quantities with consistent batch quality." } },
          { "@type": "Question", "name": "What analytical methods verify SS-31 identity and purity?", "acceptedAnswer": { "@type": "Answer", "text": "Each SS-31 30 mg batch is verified by RP-HPLC (≥98% purity, C18 column, 214 nm), ESI-TOF mass spectrometry ([M+H]⁺ = 640.4 Da), amino acid analysis (post-column ninhydrin), chiral HPLC (confirms D-Arg and L-Lys configuration), Karl Fischer water content, residual TFA analysis, and LAL endotoxin testing. A comprehensive Certificate of Analysis accompanies every shipment." } }
        ]
      }
    ]
  }
jsonLd:
  product:
    "@context": "https://schema.org"
    "@type": "Product"
    name: "SS-31 (Elamipretide) 30 mg Mitochondrial Research Peptide USA"
    description: "Research-grade SS-31 (Elamipretide) 30 mg Mitochondrial Research Peptide USA. ≥98% HPLC purity. CAS: 1382080-17-0. Mitochondria-Targeted Tetrapeptide. Lyophilized powder for laboratory research."
    sku: "HKPW-SS-31-30-MG-MITOCHONDRIAL-RESEARCH-PEPTIDE-USA"
    brand:
      "@type": "Brand"
...
| **Cardiolipin Binding Activity** | SPR (cardiolipin L1 chip) | Kd ≤ 200 nM |

---

## Available SS-31 Research Formats: Complete Comparison

| Product Variant | Catalog Number | Quantity | Mouse Study Duration (5 mg/kg, n=10) | Seahorse XF96 Full Plates* | Price per mg (relative) |
|---|---|---|---|---|---|
| SS-31 5 mg | SS31-005-USA | 5 mg | 1 day | 2-3 plates | Baseline |
| SS-31 10 mg | SS31-010-USA | 10 mg | 3 days | 5-6 plates | ~15% lower |
| SS-31 15 mg | SS31-015-USA | 15 mg | 4 days | 8-12 plates | ~25% lower |
| **SS-31 30 mg (current)** | **SS31-030-USA** | **30 mg** | **8 days** | **16-24 plates** | **~35% lower** |
| Custom Bulk | SS31-BULK-USA | Inquire | Per protocol | Per protocol | Volume-discounted |
...
### 3. What is the recommended SS-31 dose for mouse models of heart failure?
...
| Feature | SS-31 (Elamipretide) | MitoQ | MitoTEMPO | SkQ1 | XJB-5-131 |
|---|---|---|---|---|---|
| **Chemical Class** | Tetrapeptide | TPP⁺-ubiquinone | TPP⁺-nitroxide | TPP⁺-plastoquinone | Nitroxide-peptide |
| **Targeting Strategy** | ΔΨm + cardiolipin binding | TPP⁺ cation, ΔΨm | TPP⁺ cation, ΔΨm | TPP⁺ cation, ΔΨm | ΔΨm + IMM targeting |
| **Protective Mechanism** | Cardiolipin stabilization | Radical scavenging + redox cycling | Superoxide dismutation | Radical scavenging | Radical scavenging |
| **Mitochondrial Accumulation** | 1000-5000× | 100-500× | 100-500× | 100-500× | 500-1000× |
| **Selectivity** | High (cardiolipin-specific) | Broad | Broad | Broad | Moderate |
| **Clinical Stage** | Phase II/III | Phase II | Preclinical | Preclinical (ophthalmic) | Preclinical |
| **Key Advantage** | Substrate-level protection | Commercial availability | SOD mimetic activity | Environmental adaptation-inspired | Dual targeting mechanism |
| **Key Limitation** | Peptide stability concerns | Potential mitochondrial uncoupling at high doses | Limited in vivo data | Limited Western availability | Limited published characterization |
