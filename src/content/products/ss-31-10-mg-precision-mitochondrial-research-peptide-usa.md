---
title: "SS-31 10 mg Precision Mitochondrial Research Peptide USA"
...
schema_jsonld: |
  {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "FAQPage",
        "mainEntity": [
          { "@type": "Question", "name": "How does the SS-31 10 mg format compare to the 5 mg format for research throughput?", "acceptedAnswer": { "@type": "Answer", "text": "The SS-31 10 mg format provides twice the material of the 5 mg configuration, enabling multi-endpoint experimental designs in which the same batch of reconstituted peptide can be used across parallel assays — for example, simultaneous Seahorse bioenergetics analysis, ROS quantification (MitoSOX), and Western blotting for mitochondrial protein markers. The 10 mg format supports approximately 250-500 individual wells in standard 96-well plate formats, compared to 125-250 wells for the 5 mg vial." } },
          { "@type": "Question", "name": "What in vivo experimental designs benefit from the SS-31 10 mg format?", "acceptedAnswer": { "@type": "Answer", "text": "The 10 mg format supports acute in vivo pilot studies in rodent models at standard doses (2-5 mg/kg IP or SC). A 10 mg vial provides sufficient material for dosing 2-5 mice at 5 mg/kg or for a multiday pilot protocol (e.g., 3 days at 2 mg/kg/day in 2 mice). This format is ideal for pharmacokinetic characterization, target engagement studies (cardiolipin binding assays on tissue homogenates), and preliminary efficacy screening before scaling to larger cohorts." } },
          { "@type": "Question", "name": "What is the appropriate reconstitution volume for SS-31 10 mg for in vitro use?", "acceptedAnswer": { "@type": "Answer", "text": "For in vitro applications, reconstitute SS-31 10 mg in 2-10 mL of sterile PBS, water, or 0.9% saline, yielding a 1-5 mg/mL stock solution. At a 1 mg/mL stock concentration, the 10 mg vial produces 10 mL of solution — sufficient for extensive dose-response characterization across multiple independent experiments. Working concentrations typically range from 10 nM to 10 μM, so a 1 mg/mL stock (≈1.56 mM) requires 10,000- to 100,000-fold dilution for most cellular assays." } },
          { "@type": "Question", "name": "How stable is SS-31 under cell culture conditions?", "acceptedAnswer": { "@type": "Answer", "text": "SS-31 demonstrates excellent stability in standard cell culture media (DMEM, RPMI-1640) at 37°C, with >90% intact peptide remaining after 24 hours as determined by LC-MS/MS analysis. The D-amino acid at position 1 (D-Arg) confers resistance to aminopeptidase degradation, and the C-terminal amide protects against carboxypeptidase activity. Researchers conducting extended time-course experiments (48-72 hours) may consider media refreshment at 24-hour intervals." } },
          { "@type": "Question", "name": "Can SS-31 10 mg be used with mitochondrial isolation kits?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, SS-31 10 mg is commonly used in protocols employing mitochondrial isolation from cultured cells or tissue homogenates via differential centrifugation or commercial kit-based methods. Pre-treatment of cells or tissues with SS-31 (100-500 nM, 1-4 hours) prior to mitochondrial isolation preserves respiratory function and reduces ROS production in subsequently isolated organelles, as demonstrated by improved respiratory control ratios (RCR) and attenuated mitochondrial swelling." } }
        ]
      }
    ]
  }
jsonLd:
  product:
    "@context": "https://schema.org"
    "@type": "Product"
    name: "SS-31 (Elamipretide) 10 mg Mitochondrial Research Peptide USA"
    description: "Research-grade SS-31 (Elamipretide) 10 mg Mitochondrial Research Peptide USA. ≥98% HPLC purity. CAS: 1382080-17-0. Mitochondria-Targeted Tetrapeptide. Lyophilized powder for laboratory research."
    sku: "HKPW-SS-31-10-MG-PRECISION-MITOCHONDRIAL-RESEARCH-PEPTI"
    brand:
      "@type": "Brand"
...
| **Chiral Purity** | Chiral HPLC (Crownpak CR(+)) | ≥99% D-configuration at Arg; ≥98% L-configuration at Lys |

---

## Available SS-31 Research Formats

| Product Variant | Catalog Number | Quantity | In Vitro Wells (96-well, 100 μL, 1 μM)* | Acute Mouse Doses (5 mg/kg, 25 g) | Recommended Application |
|---|---|---|---|---|---|
| SS-31 5 mg | SS31-005-USA | 5 mg | ~800 | ~1 | Pilot studies, method validation |
| **SS-31 10 mg (current)** | **SS31-010-USA** | **10 mg** | **~1,600** | **~2** | **Multi-endpoint assays, pilot PK** |
| SS-31 15 mg | SS31-015-USA | 15 mg | ~2,400 | ~3 | Seahorse panels, moderate throughput |
| SS-31 30 mg | SS31-030-USA | 30 mg | ~4,800 | ~6 | Extended in vivo, core facilities |
| Custom Bulk | SS31-BULK-USA | Inquire | — | — | Large-scale programs, multi-institutional |
...
| Parameter | SS-31 5 mg | SS-31 10 mg | SS-31 15 mg | SS-31 30 mg |
|---|---|---|---|---|
| **Total Material** | 5 mg | 10 mg | 15 mg | 30 mg |
| **Stock Volume at 1 mg/mL** | 5 mL | 10 mL | 15 mL | 30 mL |
| **96-Well Assays (1 μM, 100 μL)** | ~800 wells | ~1,600 wells | ~2,400 wells | ~4,800 wells |
| **Mouse Doses (5 mg/kg, 25 g)** | 1 dose | 2 doses | 3 doses | 6 doses |
| **Seahorse XF96 Plates (full)** | 2-3 plates | 5-6 plates | 8-9 plates | 16-18 plates |
| **Best For** | Pilot, method development | Multi-endpoint mechanistic | Seahorse panels, moderate throughput | In vivo, longitudinal, core facilities |
| **Purity** | ≥98% | ≥98% | ≥98% | ≥98% |
| **Price Efficiency** | Highest per-mg cost | Improved per-mg | Better per-mg value | Best per-mg value for scale |
