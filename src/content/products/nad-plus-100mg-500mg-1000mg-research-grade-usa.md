...
document_id: "HKPW-nad-plus-research-grade-nicotinamide-adenine-dinucleotide-v1.0"
jsonLd:
  product:
    "@context": "https://schema.org"
    "@type": "Product"
    name: "NAD+ Research Compound | 100 mg / 500 mg / 1000 mg Configurations"
    description: "Research-grade Nicotinamide Adenine Dinucleotide (NAD+, oxidized form), ≥98% HPLC purity. Available in 100 mg, 500 mg, and 1000 mg configurations. CAS: 53-84-9. MW: 663.4 Da. Lyophilized powder for sirtuin, PARP, CD38, and cellular metabolism research."
    sku: "HKPW-NAD-100MG"
    brand:
      "@type": "Brand"
  ...
  faqPage:
    ...
    mainEntity:
      - "@type": "Question"
        name: "What is the difference between NAD+ and NADH?"
        acceptedAnswer:
          "@type": "Answer"
          text: "NAD+ is the oxidized form and serves as an electron acceptor in catabolic reactions (glycolysis, TCA cycle, fatty acid oxidation) and as a substrate for sirtuins, PARPs, and CD38. NADH is the reduced form and serves as an electron donor for oxidative phosphorylation (Complex I). The NAD+/NADH ratio is a critical determinant of cellular redox state: a high ratio favors oxidative metabolism and sirtuin activation; a low ratio indicates reductive stress. HKPEPTIDE WORLDWIDE supplies the oxidized NAD+ form; researchers requiring NADH should inquire separately."
      - "@type": "Question"
        name: "Why are three dosage configurations (100 mg, 500 mg, 1000 mg) offered?"
        acceptedAnswer:
          "@type": "Answer"
          text: "The 100 mg configuration is optimal for pilot studies, enzyme assay development, and cell culture dose-response experiments. The 500 mg configuration supports extended protocols, multi-arm study designs, and combination pharmacology experiments. The 1000 mg configuration is reserved for comprehensive longitudinal research programs, large-scale enzymatic assays, and institutional core facility supply."
      - "@type": "Question"
        name: "Is NAD+ orally bioavailable in research models?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Intact NAD+ is poorly absorbed in the gastrointestinal tract due to its charged pyrophosphate moiety and susceptibility to intestinal phosphatases. Research models typically employ NAD+ precursors—nicotinamide riboside (NR), nicotinamide mononucleotide (NMN), or nicotinamide (NAM)—for in vivo NAD+ augmentation studies. NAD+ itself is primarily used in cell culture, enzyme assay, and biochemical research applications."
      - "@type": "Question"
        name: "What quality control tests are performed on NAD+?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Each batch undergoes RP-HPLC purity analysis (≥98%), UV-Vis spectrophotometric confirmation (λmax 260 nm, A250/A260 ratio), ESI-MS molecular weight confirmation, enzymatic activity assay with alcohol dehydrogenase (ADH), Karl Fischer moisture (≤5%), and endotoxin testing (≤1.0 EU/mg). A batch-specific CoA is included with every shipment."
      - "@type": "Question"
        name: "How should NAD+ be stored to maintain stability?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Lyophilized NAD+ should be stored at -20°C in a desiccated, light-protected environment. NAD+ is hygroscopic—exposure to atmospheric moisture causes rapid degradation via hydrolysis of the nicotinamide-ribose glycosidic bond. Once reconstituted in sterile water or PBS (pH 7.0–7.4), aliquot single-use volumes and store at -80°C. Avoid freeze-thaw cycles and prolonged exposure to neutral-to-alkaline pH."
  breadcrumbList:
    "@context": "https://schema.org"
    "@type": "BreadcrumbList"
    itemListElement:
...
*© 2026 HKPEPTIDE WORLDWIDE. All rights reserved. Document ID: HKPW-nad-plus-research-grade-nicotinamide-adenine-dinucleotide-v1.0*
