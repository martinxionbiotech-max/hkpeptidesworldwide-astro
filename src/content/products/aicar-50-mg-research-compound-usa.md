...
schema_jsonld: |
  {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "FAQPage",
        "mainEntity": [
          { "@type": "Question", "name": "What is the difference between AICAR 5 mg and AICAR 50 mg formats?", "acceptedAnswer": { "@type": "Answer", "text": "The AICAR 50 mg vial contains ten times the quantity of the 5 mg format, making it suitable for laboratories conducting high-throughput screens, extended in-vivo protocols requiring chronic administration, or large-volume cell culture experiments. Both formats maintain identical ≥98% purity specifications and undergo identical quality control analytical testing." } },
          { "@type": "Question", "name": "How many in-vivo rodent experiments can the AICAR 50 mg format support?", "acceptedAnswer": { "@type": "Answer", "text": "At a standard acute IP dose of 0.5 g/kg, a 50 mg vial provides sufficient compound for a single 100 g rat. For chronic mouse studies utilizing 0.25 g/kg daily dosing, the 50 mg format supports approximately 8–10 doses in a typical 25 g mouse model. Researchers should calculate requirements based on their specific protocol parameters." } },
          { "@type": "Question", "name": "What are the recommended solvent and storage conditions for AICAR 50 mg?", "acceptedAnswer": { "@type": "Answer", "text": "AICAR 50 mg lyophilized powder should be stored at -20°C, desiccated, and protected from light. For reconstitution, sterile water, PBS (pH 7.4), or saline are recommended. The compound is freely soluble at ≥10 mg/mL. Reconstituted aliquots should be stored at -20°C and used within 30 days. Multiple smaller aliquots are recommended to avoid repeated freeze-thaw cycles." } },
          { "@type": "Question", "name": "What analytical documentation accompanies AICAR 50 mg orders?", "acceptedAnswer": { "@type": "Answer", "text": "Each AICAR 50 mg shipment includes a batch-specific Certificate of Analysis (CoA) documenting HPLC purity (≥98%), LC-MS identity confirmation (m/z 339.1 [M+H]⁺), residual solvent analysis per USP <467>, Karl Fischer water content, LAL endotoxin testing, and appearance assessment. Researchers may request additional analytical data from our quality control department." } },
          { "@type": "Question", "name": "Can AICAR 50 mg be used in combination with other AMPK modulators?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, AICAR 50 mg is frequently deployed in research protocols alongside complementary pharmacological tools including AMPK inhibitor Compound C (dorsomorphin), mTOR inhibitor rapamycin, PPARδ agonist GW501516, and metformin. These combinatorial approaches enable dissection of crosstalk between AMPK signaling and parallel metabolic regulatory pathways." } }
        ]
      }
    ]
  }
jsonLd:
  product:
    "@context": "https://schema.org"
    "@type": "Product"
    name: "AICAR 50 mg Research Compound USA"
    description: "Research-grade AICAR 50 mg Research Compound USA. ≥98% HPLC purity. CAS: 2627-69-2. AMPK Activator. Lyophilized powder for laboratory research."
    sku: "HKPW-AICAR-50-MG-RESEARCH-COMPOUND-USA"
    brand:
      "@type": "Brand"
...
| **Synonyms** | Acadesine, AICA Ribonucleotide, AICA-RP, ZMP prodrug |
| **Purity (HPLC)** | ≥98% |
...
| **Heavy Metals** | ICP-MS | As ≤1.5 ppm, Cd ≤1.0 ppm, Hg ≤1.5 ppm, Pb ≤1.0 ppm |
| **Appearance** | Visual | White to off-white lyophilized powder |
| **Solubility** | 10 mg/mL in H₂O, 37°C | Clear, colorless solution within 2 min |
| **Bioactivity** | p-AMPKα (Thr172) ELISA, C2C12, 1 h | ≥3.5-fold increase vs. vehicle at 1 mM |

---

## Available Configurations

| Product Variant | Catalog Number | Quantity | Format | Recommended Use |
|---|---|---|---|---|
| AICAR 5 mg | AIC-005-USA | 5 mg | Single vial | Pilot studies, small-scale assays |
| AICAR 50 mg (current page) | AIC-050-USA | 50 mg | Single vial | Extended protocols, in-vivo models, HTS |
| AICAR Bulk | AIC-BULK-USA | Custom | Custom | Institutional procurement; contact HKPEPTIDE WORLDWIDE |
...
### 3. What are the recommended solvent and storage conditions for AICAR 50 mg?
