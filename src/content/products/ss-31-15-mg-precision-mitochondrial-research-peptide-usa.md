---
title: "31 15 mg"
image: "SS-31-15mg-hk-peptides-worldwide.jpg"
slug: ss-31-15-mg-precision-mitochondrial-research-peptide-usa
date: 2025-11-27
lastUpdated: 2026-08-08
source: https://hkpeptidesworldwide.com/ss-31-15-mg-precision-mitochondrial-research-peptide-usa/
...
schema_jsonld: |
  {
    ...
    "@graph": [
      {
        "@type": "Product",
        "@id": "https://hkpeptidesworldwide.com/ss-31-15-mg-precision-mitochondrial-research-peptide-usa/#product",
        "name": "SS-31 (Elamipretide) 15 mg Mitochondrial Research Peptide",
        "description": "High-purity SS-31 (Elamipretide) 15 mg, a mitochondria-targeted tetrapeptide for comprehensive mitochondrial biology research. Ideal for Seahorse XF metabolic flux panels, moderate-throughput screening, and multi-group in vivo pilot studies in United States research laboratories.",
        "sku": "SS31-15MG-USA",
      ...
      },
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 3, "name": "SS-31 15 mg", "item": "https://hkpeptidesworldwide.com/ss-31-15-mg-precision-mitochondrial-research-peptide-usa/" }
        ]
      },
      {
        "@type": "FAQPage",
        "mainEntity": [
          { "@type": "Question", "name": "Why choose the SS-31 15 mg format over the 10 mg format?", "acceptedAnswer": { "@type": "Answer", "text": "The SS-31 15 mg format provides 50% more material than the 10 mg configuration, enabling complete Seahorse XF96 metabolic flux panels (mitochondrial stress test + glycolytic stress test + ATP rate assay) from a single reconstituted stock. It also supports three-group in vivo pilot studies (vehicle vs. treatment) with adequate material for dosing and post-hoc tissue analysis." } },
          { "@type": "Question", "name": "How many Seahorse XF assays can the 15 mg format support?", "acceptedAnswer": { "@type": "Answer", "text": "The 15 mg format reconstituted at 1 mg/mL yields 15 mL of stock solution. At typical working concentrations of 100-500 nM (final well), this supports approximately 8-12 complete XF96 plates or 3-4 complete XF24 plates. For a standard mitochondrial stress test with injection ports A (oligomycin), B (FCCP), and C (rotenone/antimycin A), the 15 mg format covers thorough biological replicate experiments." } },
          { "@type": "Question", "name": "What tissue types show the greatest SS-31 accumulation?", "acceptedAnswer": { "@type": "Answer", "text": "SS-31 accumulates preferentially in tissues with high mitochondrial density: heart (left ventricle > atria), kidney (cortex > medulla, proximal tubule epithelium), brain (neurons, particularly in cortex and hippocampus), and skeletal muscle (oxidative > glycolytic fiber types). Tissue-to-plasma ratios of 20:1 to 100:1 have been reported at 30-60 minutes post-injection in rodents." } },
          { "@type": "Question", "name": "Does SS-31 affect mitochondrial biogenesis pathways?", "acceptedAnswer": { "@type": "Answer", "text": "While SS-31 is not a direct mitochondrial biogenesis inducer (unlike AICAR or bezafibrate), research indicates it may preserve PGC-1α expression under oxidative stress conditions and maintain mtDNA copy number. The mechanism appears indirect — by reducing oxidative damage to mitochondrial components, SS-31 preserves the organelle population that would otherwise be targeted for mitophagic degradation." } },
          { "@type": "Question", "name": "What distinguishes SS-31 from SS-20 and other SS-family peptides?", "acceptedAnswer": { "@type": "Answer", "text": "SS-20 (Phe-D-Arg-Phe-Lys-NH₂) is a shorter aromatic-cationic peptide from the same series but lacks the Dmt residue critical for cardiolipin binding. SS-31 demonstrates approximately 10-fold higher cardiolipin binding affinity than SS-20, translating to superior mitochondrial protection at lower concentrations. SS-31 is the most extensively characterized member of the series, with over 200 peer-reviewed publications and the most comprehensive in vivo data." } }
        ]
      }
    ]
  }
jsonLd:
  product:
    "@context": "https://schema.org"
    "@type": "Product"
    name: "SS-31 (Elamipretide) 15 mg Mitochondrial Research Peptide USA"
    description: "Research-grade SS-31 (Elamipretide) 15 mg Mitochondrial Research Peptide USA. ≥98% HPLC purity. CAS: 1382080-17-0. Mitochondria-Targeted Tetrapeptide. Lyophilized powder for laboratory research."
    sku: "HKPW-SS-31-15-MG-PRECISION-MITOCHONDRIAL-RESEARCH-PEPTI"
    brand:
      "@type": "Brand"
...
- **Seahorse XF Bioenergetics Profiling**: Complete metabolic flux analysis panels including mitochondrial stress test, glycolytic stress test, glycolytic rate assay, and ATP rate assay across multiple cell lines and treatment conditions from a single vial.

- **Moderate-Throughput Compound Screening**: Screening of SS-31 across compound libraries or genetic perturbation panels (siRNA, CRISPR) for synergistic or antagonistic interactions affecting mitochondrial function.

- **Multi-Group In Vivo Pilot Studies**: Three-arm pilot designs (vehicle control, SS-31 low dose, SS-31 high dose) in murine disease models with sufficient material for daily dosing and terminal tissue collection for mitochondrial functional assays.

- **Mitochondrial Proteomics and Phosphoproteomics**: TMT or SILAC-based quantitative proteomics of mitochondrial-enriched fractions from SS-31-treated versus control cells/tissues, with phosphopeptide enrichment for phosphoproteomic characterization of mitochondrial signaling network changes.

- **Cristae Ultrastructure Analysis**: Transmission electron microscopy (TEM) and electron tomography of mitochondrial cristae morphology in SS-31-treated tissues — the 15 mg format supports sufficient material for dose-response studies across multiple treatment groups.

- **Cardiolipin Remodeling Enzyme Studies**: Investigation of SS-31 effects on cardiolipin synthase (CLS), tafazzin (TAZ), phospholipase A2 (PLA2), and monolysocardiolipin acyltransferase (MLCLAT) expression and activity.
...
6. Sabbah, H. N., Gupta, R. C., Kohli, S., Wang, M., Hachem, S., & Zhang, K. (2016). Chronic therapy with elamipretide (MTP-131) improves left ventricular and mitochondrial function in dogs with advanced heart failure. *Circulation: Heart Failure*, 9(2), e002206.

7. Claypool, S. M., & Koehler, C. M. (2012). The complexity of cardiolipin in health and disease. *Trends in Biochemical Sciences*, 37(1), 32–41.

8. Dai, D. F., Chen, T., Szeto, H., et al. (2011). Mitochondrial targeted antioxidant peptide ameliorates hypertensive cardiomyopathy. *Journal of the American College of Cardiology*, 58(1), 73–82.
...
10. Eiyama, A., & Okamoto, K. (2015). PINK1/Parkin-mediated mitophagy in mammalian cells. *Current Opinion in Cell Biology*, 33, 95–101.
