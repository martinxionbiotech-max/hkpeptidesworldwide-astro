...
schema_jsonld: |
  {
    ...
    "@graph": [
      ...
      },
      {
        "@type": "FAQPage",
        "mainEntity": [
          { "@type": "Question", "name": "What is SS-31 (Elamipretide) and what makes it unique among mitochondrial peptides?", "acceptedAnswer": { "@type": "Answer", "text": "SS-31, also known as Elamipretide or MTP-131, is a synthetic aromatic-cationic tetrapeptide (H-D-Arg-Dmt-Lys-Phe-NH₂) that selectively and reversibly binds to cardiolipin on the inner mitochondrial membrane. Unlike conventional antioxidants that broadly scavenge reactive oxygen species, SS-31 stabilizes cardiolipin's interaction with cytochrome c and respiratory chain complexes, preserving mitochondrial architecture and electron transport efficiency." } },
          { "@type": "Question", "name": "What concentration of SS-31 should be used for mitochondrial protection assays in vitro?", "acceptedAnswer": { "@type": "Answer", "text": "In vitro mitochondrial protection studies typically employ SS-31 at concentrations of 10 nM to 1 μM. In isolated mitochondrial preparations, cardiolipin binding saturation occurs at approximately 100 nM, while cellular assays using oxidative stress inducers (H₂O₂, rotenone, antimycin A) demonstrate dose-dependent cytoprotection at 50-500 nM. The 5 mg vial reconstituted at 1 mg/mL provides sufficient material for hundreds of individual assays." } },
          { "@type": "Question", "name": "How should SS-31 5 mg be stored and reconstituted?", "acceptedAnswer": { "@type": "Answer", "text": "Lyophilized SS-31 5 mg should be stored at -20°C in a desiccated, light-protected environment (24-month stability). Reconstitute in sterile water, PBS, or 0.9% saline at 1-5 mg/mL. Prepare single-use aliquots immediately and store at -20°C. Reconstituted peptide is stable for 30 days at -20°C. Avoid repeated freeze-thaw cycles and exposure to oxidizing agents." } },
          { "@type": "Question", "name": "What is the molecular mechanism of SS-31 cardiolipin binding?", "acceptedAnswer": { "@type": "Answer", "text": "SS-31 binds cardiolipin via electrostatic interactions between the peptide's cationic residues (D-Arg and Lys) and the anionic phosphate headgroups of cardiolipin, combined with hydrophobic interactions between the Dmt (2',6'-dimethyltyrosine) and Phe aromatic side chains and the fatty acyl chains of cardiolipin. This dual-mode binding stabilizes cardiolipin within the inner mitochondrial membrane, preventing peroxidation and maintaining cristae architecture." } },
          { "@type": "Question", "name": "Is SS-31 suitable for in vivo mitochondrial research?", "acceptedAnswer": { "@type": "Answer", "text": "SS-31 has been extensively studied in preclinical rodent models of mitochondrial dysfunction including heart failure, ischemia-reperfusion injury, renal disease, and neurodegenerative disorders. The peptide demonstrates favorable pharmacokinetics with mitochondrial accumulation within minutes of systemic administration. Researchers should consult institutional IACUC guidelines and relevant literature for species-specific dosing protocols." } }
        ]
      }
    ]
  }
jsonLd:
  product:
    "@context": "https://schema.org"
    "@type": "Product"
    name: "SS-31 (Elamipretide) 5 mg Mitochondrial Research Peptide USA"
    description: "Research-grade SS-31 (Elamipretide) 5 mg Mitochondrial Research Peptide USA. ≥98% HPLC purity. CAS: 1382080-17-0. Mitochondria-Targeted Tetrapeptide. Lyophilized powder for laboratory research."
    sku: "HKPW-BUY-SS-31-5-MG-RESEARCH-PEPTIDE-USA"
    brand:
      "@type": "Brand"
...
- **Mitochondrial Bioenergetics**: Seahorse XF analysis of OCR, ECAR, and ATP production rates in cells treated with mitochondrial toxins (rotenone, oligomycin, FCCP, antimycin A). The 5 mg format is ideal for pilot mitochondrial stress test panels.

- **Oxidative Stress and Redox Biology**: Quantification of mitochondrial ROS (MitoSOX, DCFDA), lipid peroxidation (4-HNE, MDA adducts), and protein carbonylation in oxidative stress models including H₂O₂, paraquat, and hypoxia-reoxygenation.

- **Cardiolipin Biochemistry**: Investigation of cardiolipin molecular species distribution (via LC-MS/MS lipidomics) and cardiolipin oxidation products in response to SS-31 treatment, including effects on cardiolipin synthase (CLS) and tafazzin (TAZ) activity.

- **Apoptosis and Necroptosis Pathway Analysis**: Determination of cytochrome c release kinetics, caspase-3/7/9 activation, AIF translocation, and mPTP opening in cellular models of intrinsic apoptosis.

- **Neurodegeneration Research**: Mitochondrial dysfunction characterization in primary neuronal cultures, iPSC-derived neurons, and synaptosomal preparations from transgenic models of Alzheimer's, Parkinson's, and Huntington's diseases.

- **Ischemia-Reperfusion Injury**: Langendorff perfused heart models, renal IRI models, and in vitro oxygen-glucose deprivation/reperfusion paradigms assessing SS-31-mediated mitochondrial protection.

- **Comparative Mitochondrial Pharmacology**: Benchmarking novel mitochondrial-targeted compounds against the well-characterized SS-31 reference standard for cardiolipin binding affinity, mitochondrial uptake, and cytoprotective efficacy.
...
5. Kagan, V. E., Tyurin, V. A., Jiang, J., Tyurina, Y. Y., Ritov, V. B., Amoscato, A. A., Osipov, A. N., Belikova, N. A., Kapralov, A. A., Kini, V., Vlasova, I. I., Zhao, Q., Zou, M., Di, P., Svistunenko, D. A., Kurnikov, I. V., & Borisenko, G. G. (2005). Cytochrome c acts as a cardiolipin oxygenase required for release of proapoptotic factors. *Nature Chemical Biology*, 1(4), 223–232.

6. Sabbah, H. N., Gupta, R. C., Kohli, S., Wang, M., Hachem, S., & Zhang, K. (2016). Chronic therapy with elamipretide (MTP-131), a novel mitochondria-targeting peptide, improves left ventricular and mitochondrial function in dogs with advanced heart failure. *Circulation: Heart Failure*, 9(2), e002206.

7. Karaa, A., Haas, R., Goldstein, A., Vockley, J., & Cohen, B. H. (2019). A randomized crossover trial of elamipretide in adults with primary mitochondrial myopathy. *Journal of Cachexia, Sarcopenia and Muscle*, 11(4), 901–917.
...
9. Halestrap, A. P. (2009). What is the mitochondrial permeability transition pore? *Journal of Molecular and Cellular Cardiology*, 46(6), 821–831.

10. Dai, D. F., Chen, T., Szeto, H., Nieves-Cintrón, M., Kutyavin, V., Santana, L. F., & Rabinovitch, P. S. (2011). Mitochondrial targeted antioxidant peptide ameliorates hypertensive cardiomyopathy. *Journal of the American College of Cardiology*, 58(1), 73–82.
