...
class: "Tuftsin Analog / Anxiolytic Heptapeptide"
purity: "≥98% HPLC"
reviewed_by: "HKPEPTIDE WORLDWIDE Research Team"
last_updated: "2026-08-08"
document_id: "HKPW-selank-5-mg-10-mg-research-grade-tuftsin-analog-v1.0"
jsonLd:
  product:
    "@context": "https://schema.org"
    "@type": "Product"
    name: "Selank Research Peptide | 5 mg & 10 mg Configurations"
    description: "Research-grade Selank heptapeptide, ≥98% HPLC purity. Tuftsin analog with the sequence Thr-Lys-Pro-Arg-Pro-Gly-Pro. Available in 5 mg and 10 mg configurations. CAS: 129954-34-1. MW: 751.9 Da. Lyophilized powder for neuropeptide, anxiolytic, and immunomodulatory research."
    sku: "HKPW-SELANK-5MG"
    brand:
      "@type": "Brand"
  ...
  faqPage:
    ...
    mainEntity:
      - "@type": "Question"
        name: "What is the relationship between Selank and Tuftsin?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Selank is a synthetic heptapeptide analog of the endogenous immunomodulatory tetrapeptide tuftsin (Thr-Lys-Pro-Arg). Selank extends the tuftsin sequence with a C-terminal Pro-Gly-Pro tripeptide extension that confers dramatically increased metabolic stability (plasma half-life >30 minutes vs. ~2 minutes for tuftsin), enhanced blood-brain barrier penetration, and additional GABAergic activity not present in the parent tetrapeptide. Both the conserved N-terminal tuftsin tetrapeptide (immunomodulation) and the C-terminal Pro-Gly-Pro extension (CNS activity, stability) are required for Selank's full research profile."
      - "@type": "Question"
        name: "What are Selank's primary mechanisms of action?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Selank operates through a multi-modal mechanism: (1) positive allosteric modulation of GABA-A receptors at a site distinct from the benzodiazepine binding site, producing anxiolysis without sedation; (2) upregulation of brain-derived neurotrophic factor (BDNF) in the hippocampus and prefrontal cortex; (3) modulation of the expression of interleukin-6 (IL-6) and other inflammatory cytokines; (4) stabilization of enkephalins through inhibition of enkephalin-degrading enzymes (enkephalinase inhibition); and (5) interaction with the tuftsin receptor (neuropilin-1) on immune cells, producing immunomodulatory effects."
      - "@type": "Question"
        name: "How does Selank differ from conventional benzodiazepine anxiolytics?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Selank modulates GABA-A receptors as a positive allosteric modulator but binds to a site distinct from the benzodiazepine binding site. This means Selank enhances GABAergic tone at activated synapses without producing the sedation, tolerance, dependence, or withdrawal syndromes associated with benzodiazepines. Selank does not cause myorelaxation, amnesia, or psychomotor impairment at research-relevant concentrations—a profile that distinguishes it from classical anxiolytics and makes it an attractive research tool for studying non-benzodiazepine GABAergic mechanisms."
      - "@type": "Question"
        name: "Is Selank stable in solution?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Selank exhibits superior stability compared to most neuropeptides due to its high proline content (3 of 7 residues), which confers resistance to proteolytic degradation. The Pro-Gly-Pro C-terminal motif is particularly resistant to carboxypeptidase cleavage. Reconstituted Selank in sterile PBS (pH 7.0–7.4) is stable for 30 days at 2–8°C. For extended storage, aliquot and freeze at -20°C. Avoid freeze-thaw cycles beyond 3 cycles."
      - "@type": "Question"
        name: "What analytical characterization is provided?"
        acceptedAnswer:
          "@type": "Answer"
          text: "Each batch includes RP-HPLC purity analysis (≥98%), ESI-MS molecular weight confirmation (751.9 ± 0.5 Da), LC-MS/MS peptide sequencing (100% sequence coverage), amino acid analysis (≥85% net peptide), Karl Fischer moisture (≤5%), and endotoxin testing (≤1.0 EU/mg). A full Certificate of Analysis is included with every shipment."
  breadcrumbList:
    "@context": "https://schema.org"
    "@type": "BreadcrumbList"
    itemListElement:
...
| **Molecular Weight** | ESI-MS | 751.9 ± 0.5 Da |
...
| **Counterion** | HPLC-MS | Acetate (standard); trifluoroacetate-free |
...
|---|---|---|---|
| 1 Vial | $65.00 | $105.00 | HKPW-SELANK-5MG / HKPW-SELANK-10MG |
| 5 Vials | $58.50/vial ($292.50) | $94.50/vial ($472.50) | Multi-pack |
| 10 Vials | $52.00/vial ($520.00) | $84.00/vial ($840.00) | Multi-pack |
| 25+ Vials | Contact for bulk | Contact for bulk | HKPW-SELANK-BULK |
...
*© 2026 HKPEPTIDE WORLDWIDE. All rights reserved. Document ID: HKPW-selank-5-mg-10-mg-research-grade-tuftsin-analog-v1.0*
